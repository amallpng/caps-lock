...
const AboutPage: React.FC = () => {
  return (
    <div className="w-full max-w-4xl bg-[#D3CFC2]/50 p-8 rounded-sm border-2 border-[#A9A391] flex flex-col gap-8 leading-relaxed">
      <div>
        <h1 className="text-4xl font-bold text-[#4A6B69] text-center mb-4">About CAPS LOCK</h1>
      ...
      <div className="w-full border-t-2 border-dashed border-[#A9A391] pt-6">
        <h2 className="text-3xl font-bold text-[#4A6B69] mb-4">Features</h2>
        <ul className="space-y-4 list-disc list-inside text-gray-800">
          <li>
            <strong className="font-semibold text-[#282828]">Practice Mode:</strong> Hone your skills in a flexible environment. Choose your desired difficulty (Easy, Medium, Hard) and session duration (15s, 30s, 60s, 120s) to create the perfect practice session.
          </li>
          <li>
            <strong className="font-semibold text-[#282828]">100 Challenge Levels:</strong> Embark on a journey from a typing novice to a titan! Progress through 100 carefully crafted levels, each with specific WPM and accuracy goals. Unlock unique, animated badges as you complete milestones.
          </li>
          <li>
            <strong className="font-semibold text-[#282828]">Personalized Profile:</strong> Your profile is your typing hub. Track your best WPM, daily streak, and performance history with our analysis chart. Customize your avatar and view your collection of earned badges.
          </li>
          <li>
            <strong className="font-semibold text-[#282828]">Competitive Leaderboard:</strong> See how you stack up against other typists! The leaderboard ranks all users by their best WPM, with special honors for the top three.
          </li>
        </ul>
      </div>
      
      <div className="w-full border-t-2 border-dashed border-[#A9A391] pt-6 text-center">
         <h2 className="text-3xl font-bold text-[#4A6B69] mb-4">About the Creator</h2>
         ...
         <div className="flex justify-center items-center gap-6 mt-4">
            <a href="mailto:amalazeesa@gmail.com" className="flex items-center gap-2 text-[#4A6B69] hover:underline font-semibold">
            ...
            <a href="https://www.instagram.com/amall.png_/?hl=en" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#4A6B69] hover:underline font-semibold">
