...
const LoginPage: React.FC<LoginPageProps> = ({ onLogin, onSwitchToRegister }) => {
  ...
  return (
    <div className="w-full max-w-md bg-[#D3CFC2] p-8 rounded-sm border-2 border-[#282828] shadow-lg">
      ...
      <h2 className="text-2xl font-bold text-center text-[#282828] mb-6">Login</h2>
      ...
      <p className="mt-6 text-center text-gray-700">
        ...
        <button onClick={onSwitchToRegister} className="text-[#4A6B69] hover:underline font-semibold">
          Register here
        </button>
      </p>
    </div>
